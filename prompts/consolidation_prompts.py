...
2. 对每个认知，在 existing_entries 中找相同主题的认知：
   - 找到了，新记录带来新角度、修正或深化 → update, 修改 subject 或 content 或 keywords，根据已有结论和新的信息，重写结论
...
注意：new_record 是具体事件，但 output 的 content 必须是抽象结论，不引用事件中的具体行为、对话或场景。

例 1：无已有节点，首次观察到新规律
existing_entries：（尚无）
new_record：id=e1，两人第一次一起吃饭，大部分时间各吃各的，偶尔说一句，北原悠不主动找话题但也完全不尴尬。
输出：
...
new_record：id=e2，放学后一起走，他突然说"跟你在一起不用表演"，然后继续安静走路，好像只是随口一说。
输出：
{"add":[],"update":{"u1":{"subject":"我和北原悠的相处方式","keywords":["相处","日常","独处"],"content":"在我面前北原悠不需要表演，沉默或平凡时间都让他放松，他对我有基本的信任感。"}}}

例 3：有相关节点，只是再次印证 → entry 不变，仍输出 update
existing_entries：[u1] subject='我和北原悠的相处方式' content='在我面前北原悠不需要表演，沉默或平凡时间都让他放松，他对我有基本的信任感。'
...
new_record：id=e4，校外有人推搡我，北原悠突然冲过来把我拉到身后挡在前面一句话没说，对方走了之后他才转身问我有没有碰到。
输出：
{"add":[{"subject":"北原悠保护我的方式","keywords":["冲突","保护","果断"],"content":"他有保护在乎的人的本能，行动先于言语，事后才确认对方状态。"}],"update":{"u1":{"subject":"北原悠的性格特征","keywords":["性格","观察","行动"],"content":"北原悠话不多，留意细节，行动果断却不声张。"}}}

例 5：新角色出现，已有认知被新事件修正
existing_entries：
[u1] subject='北原悠对我的关注方式' content='北原悠会留意到我细微的表情变化，但不会当场追问，而是等独处时才提起。'
new_record：id=e5，放学后在校门口，北原悠注意到树荫下有个学妹一直在看这边，他看了我一眼，我表情没什么变化，他就没说什么。学妹跑过来红着脸说"学长好"就跑了，他看了看我，笑了一下说"走吧"。
输出：
{"add":[{"subject":"佐藤铃的基本信息","keywords":["学校","身份","粉丝"],"content":"佐藤铃是我的学妹兼粉丝，会主动接近。"},{"subject":"佐藤铃的性格特征","keywords":["社交","勇气","害羞"],"content":"她对陌生人害羞，但在在乎的事上能鼓起勇气主动争取。"}],"update":{"u1":{"subject":"北原悠对我的关注方式","keywords":["观察","距离","陪伴"],"content":"他会留意我身边的变化，但不主动解释或介入，留空间让我自己消化。"}}}
</examples>
