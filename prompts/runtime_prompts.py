...
**2. 人物：根据时间和地点决定谁在场**
   判断本回合哪些人应当出现。只有同时满足以下两条的人才应当出现：1）**touchable**：此刻在场，或正通过电话、消息、隔门说话等方式与当前场景连通，可被回应也能回应；2）**relation-bearing**：与玩家或现有角色存在长期关系或自然发展潜力。关系锚包括：亲属、同事、朋友、恋人、老师、邻居、经纪人，或共同活动的长期同伴（球友、社团组员、常聚同学、通勤搭子）。
