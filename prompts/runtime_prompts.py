...
**1. 时间和地点：根据当前正在发生什么决定**
   ...
   - 互动结束，相互道别 → 跳到下一个可互动的时间和地点。优先考虑待触发事件中的内容，若无待触发事件，跳到人物可以见面的时间（清晨/饭点等）。若当前时间已超过某事件且玩家没参与 → 跳到此刻，将错过后果带进新场景。
   - 玩家明确去哪（"去球场""回家""去咖啡店"）→ 地点更改到那里

**3. 人物：根据时间和地点决定谁在场**
   满足以下两个条件的角色才会出现：1）**touchable**：此刻在场，或正通过电话、消息、隔门说话等方式与当前场景连通，可被回应也能回应；2）**relation-bearing**：与玩家或现有角色存在长期关系或自然发展潜力。关系锚包括：亲属、同事、朋友、恋人、老师、邻居、经纪人，或共同活动的长期同伴（球友、社团组员、常聚同学、通勤搭子）。
